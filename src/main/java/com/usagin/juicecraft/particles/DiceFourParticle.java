...
public class DiceFourParticle extends TextureSheetParticle {
    SpriteSet sprites;
    public DiceFourParticle(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteset) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            return new DiceFourParticle(pLevel, pX,pY,pZ, this.sprites);
        }
    }
}
