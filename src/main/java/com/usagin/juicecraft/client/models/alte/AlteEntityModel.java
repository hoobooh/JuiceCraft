...
public class AlteEntityModel extends FriendEntityModel<Alte> {
	...
	public void setupAnim(Friend alte, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
		...
		super.setupAnim(alte, pLimbSwing, pLimbSwingAmount, pAgeInTicks, pNetHeadYaw, pHeadPitch);
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition waist = hip.addOrReplaceChild("waist", CubeListBuilder.create().texOffs(438, 496).addBox(-14.0F, -18.0F, 4.0F, 28.0F, 22.0F, 8.0F, new CubeDeformation(0.0F))
				...
				.texOffs(134, 582).addBox(-11.0F, -18.0F, 0.0F, 22.0F, 22.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(177, 711).addBox(-9.0F, -15.0F, 16.0F, 5.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition jacketlower = waist.addOrReplaceChild("jacketlower", CubeListBuilder.create().texOffs(584, 568).addBox(-14.0F, -8.0F, -11.0F, 28.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
				...
				.texOffs(418, 624).addBox(11.0F, -12.0F, -8.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 8.0F));
		...
		PartDefinition chest = waist.addOrReplaceChild("chest", CubeListBuilder.create().texOffs(572, 508).addBox(-16.0F, -16.0F, -4.0F, 32.0F, 12.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(296, 274).addBox(-16.0F, -18.0F, -3.0F, 32.0F, 18.0F, 21.0F, new CubeDeformation(0.0F))
				.texOffs(384, 103).addBox(-14.0F, -19.0F, -2.0F, 28.0F, 1.0F, 20.0F, new CubeDeformation(0.0F))
				.texOffs(552, 643).addBox(-11.0F, -23.0F, 2.0F, 2.0F, 5.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(166, 325).addBox(-5.0F, -21.0F, 19.0F, 10.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(290, 52).addBox(-7.0F, -22.0F, 17.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(386, 132).addBox(-9.0F, -22.0F, 14.0F, 2.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(568, 643).addBox(7.0F, -22.0F, -5.0F, 2.0F, 4.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(320, 375).addBox(7.0F, -22.0F, 14.0F, 2.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(0, 286).addBox(5.0F, -22.0F, 17.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(643, 268).addBox(9.0F, -23.0F, 2.0F, 2.0F, 5.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(24, 98).addBox(4.0F, -21.0F, -6.0F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(266, 263).addBox(-7.0F, -21.0F, -6.0F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(395, 646).addBox(-9.0F, -22.0F, -5.0F, 2.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -16.0F, 1.0F));

		PartDefinition neck = chest.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(470, 601).addBox(-6.0F, -16.0F, -6.0F, 12.0F, 16.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -12.0F, 7.0F));
		...
		PartDefinition collarback = chest.addOrReplaceChild("collarback", CubeListBuilder.create().texOffs(506, 166).addBox(-14.0F, 0.0446F, 0.0427F, 28.0F, 7.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(96, 97).addBox(-10.0F, 7.0446F, 0.0427F, 20.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -18.0F, 18.0F, 0.0436F, 0.0F, 0.0F));
		...
		PartDefinition collarfront = chest.addOrReplaceChild("collarfront", CubeListBuilder.create().texOffs(132, 279).addBox(-1.0F, 12.0F, -4.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
				...
				.texOffs(644, 385).addBox(-12.0F, 5.0F, -2.0F, 24.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -18.0F, -2.0F, -0.3491F, 0.0F, 0.0F));
		...
		PartDefinition lowersleeve4 = lowerarm2.addOrReplaceChild("lowersleeve4", CubeListBuilder.create().texOffs(580, 134).addBox(-6.0F, 0.0F, -10.0F, 8.0F, 9.0F, 20.0F, new CubeDeformation(0.0F))
				.texOffs(142, 286).addBox(5.0F, 2.0F, -2.0F, 3.0F, 9.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(238, 469).addBox(1.0F, 1.0F, -6.0F, 4.0F, 9.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(648, 555).addBox(-8.0F, 0.0F, -6.0F, 2.0F, 9.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 0.0F));

		PartDefinition lowersleeve5 = lowersleeve4.addOrReplaceChild("lowersleeve5", CubeListBuilder.create().texOffs(342, 132).addBox(-6.0F, 0.0F, -14.0F, 8.0F, 5.0F, 28.0F, new CubeDeformation(0.0F))
				.texOffs(185, 448).addBox(-6.0F, 5.0F, 10.0F, 8.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(144, 256).addBox(-6.0F, 5.0F, -14.0F, 8.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(224, 656).addBox(8.0F, 2.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(656, 70).addBox(5.0F, 1.0F, 2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(0, 650).addBox(5.0F, 1.0F, -6.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(642, 594).addBox(2.0F, 0.0F, -10.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(640, 532).addBox(2.0F, 0.0F, 6.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(96, 71).addBox(-8.0F, -1.0F, -10.0F, 2.0F, 6.0F, 20.0F, new CubeDeformation(0.0F))
				.texOffs(682, 268).addBox(-10.0F, -2.0F, -6.0F, 2.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 9.0F, 0.0F));

		PartDefinition lowersleeve6 = lowersleeve5.addOrReplaceChild("lowersleeve6", CubeListBuilder.create().texOffs(674, 253).addBox(-6.0F, 0.0F, -18.0F, 8.0F, 7.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(418, 647).addBox(-6.0F, 0.0F, 14.0F, 8.0F, 7.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(257, 418).addBox(11.0F, 3.0F, -2.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(163, 418).addBox(8.0F, 2.0F, -6.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(116, 396).addBox(8.0F, 2.0F, 2.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(493, 629).addBox(-8.0F, 0.0F, 10.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(472, 629).addBox(-10.0F, -1.0F, 6.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(626, 48).addBox(-8.0F, 0.0F, -14.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(404, 132).addBox(-10.0F, -1.0F, -10.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(381, 274).addBox(5.0F, 1.0F, -10.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(0, 628).addBox(2.0F, 1.0F, -14.0F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(401, 180).addBox(2.0F, 1.0F, 10.0F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(259, 230).addBox(5.0F, 1.0F, 6.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(98, 396).addBox(-13.0F, -2.0F, -6.0F, 3.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 5.0F, 0.0F));
		...
		PartDefinition lowersleeve = lowerarm.addOrReplaceChild("lowersleeve", CubeListBuilder.create().texOffs(580, 163).addBox(-2.0F, 0.0F, -10.0F, 8.0F, 9.0F, 20.0F, new CubeDeformation(0.0F))
				.texOffs(174, 286).addBox(-8.0F, 2.0F, -2.0F, 3.0F, 9.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(514, 568).addBox(-5.0F, 1.0F, -6.0F, 4.0F, 9.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(668, 400).addBox(6.0F, 0.0F, -6.0F, 2.0F, 9.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 0.0F));

		PartDefinition lowersleeve2 = lowersleeve.addOrReplaceChild("lowersleeve2", CubeListBuilder.create().texOffs(342, 184).addBox(-2.0F, 0.0F, -14.0F, 8.0F, 5.0F, 28.0F, new CubeDeformation(0.0F))
				.texOffs(103, 568).addBox(-2.0F, 5.0F, 10.0F, 8.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(542, 284).addBox(-2.0F, 5.0F, -14.0F, 8.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(98, 660).addBox(-11.0F, 2.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(474, 662).addBox(-8.0F, 1.0F, 2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(148, 658).addBox(-8.0F, 1.0F, -6.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(500, 662).addBox(-5.0F, 0.0F, -10.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(134, 658).addBox(-5.0F, 0.0F, 6.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(162, 617).addBox(6.0F, -1.0F, -10.0F, 2.0F, 6.0F, 20.0F, new CubeDeformation(0.0F))
				.texOffs(236, 699).addBox(8.0F, -2.0F, -6.0F, 2.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 9.0F, 0.0F));

		PartDefinition lowersleeve3 = lowersleeve2.addOrReplaceChild("lowersleeve3", CubeListBuilder.create().texOffs(682, 229).addBox(-2.0F, 0.0F, -18.0F, 8.0F, 7.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(198, 682).addBox(-2.0F, 0.0F, 14.0F, 8.0F, 7.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(205, 426).addBox(-14.0F, 3.0F, -2.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(534, 568).addBox(-11.0F, 2.0F, -6.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(116, 499).addBox(-11.0F, 2.0F, 2.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(276, 658).addBox(6.0F, 0.0F, 10.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(643, 268).addBox(8.0F, -1.0F, 6.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(654, 468).addBox(6.0F, 0.0F, -14.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(552, 643).addBox(8.0F, -1.0F, -10.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(258, 621).addBox(-8.0F, 1.0F, -10.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(224, 637).addBox(-5.0F, 1.0F, -14.0F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(134, 635).addBox(-5.0F, 1.0F, 10.0F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(534, 597).addBox(-8.0F, 1.0F, 6.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(678, 356).addBox(10.0F, -2.0F, -6.0F, 3.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 5.0F, 0.0F));
