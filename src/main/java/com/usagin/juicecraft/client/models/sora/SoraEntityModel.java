...
public class SoraEntityModel extends HierarchicalModel<Sora> implements ArmedModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(220, 48).addBox(-8.0F, 40.0F, -8.0F, 16.0F, 20.0F, 16.0F, new CubeDeformation(0.0F))
		.texOffs(268, 124).addBox(-12.0F, 48.0F, 0.0F, 24.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-12.0F, -60.0F, 4.0F));

		PartDefinition shoecuff = rightleg.addOrReplaceChild("shoecuff", CubeListBuilder.create().texOffs(272, 36).addBox(-25.0F, -20.0F, -4.0F, 4.0F, 8.0F, 16.0F, new CubeDeformation(0.0F))
		...
		.texOffs(296, 36).addBox(-21.0F, -20.0F, 12.0F, 16.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(13.0F, 60.0F, -4.0F));

		PartDefinition bone = rightleg.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(204, 288).addBox(-25.0F, -4.0F, -4.0F, 4.0F, 4.0F, 16.0F, new CubeDeformation(0.0F))
		...
		.texOffs(308, 12).addBox(-21.0F, -4.0F, 12.0F, 16.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(13.0F, 60.0F, -4.0F));
		...
		PartDefinition leftarm = Friend.addOrReplaceChild("leftarm", CubeListBuilder.create().texOffs(228, 244).addBox(-2.0F, 45.0F, -8.0F, 16.0F, 4.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(16.0F, -113.0F, 6.0F));

		PartDefinition base5 = leftarm.addOrReplaceChild("base5", CubeListBuilder.create().texOffs(148, 160).addBox(5.0F, -121.0F, 0.0F, 4.0F, 60.0F, 12.0F, new CubeDeformation(0.0F))
		.texOffs(248, 264).addBox(13.0F, -113.0F, 4.0F, 4.0F, 52.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(180, 192).addBox(9.0F, -117.0F, 0.0F, 4.0F, 56.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 114.0F, -6.0F));

		PartDefinition rightarm = Friend.addOrReplaceChild("rightarm", CubeListBuilder.create().texOffs(244, 224).addBox(-14.0F, 45.0F, -8.0F, 16.0F, 4.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(-16.0F, -113.0F, 6.0F));

		PartDefinition base4 = rightarm.addOrReplaceChild("base4", CubeListBuilder.create().texOffs(96, 172).addBox(-20.0F, -121.0F, 0.0F, 4.0F, 60.0F, 12.0F, new CubeDeformation(0.0F))
		.texOffs(264, 264).addBox(-28.0F, -113.0F, 4.0F, 4.0F, 52.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(212, 192).addBox(-24.0F, -117.0F, 0.0F, 4.0F, 56.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(16.0F, 114.0F, -6.0F));
		...
		PartDefinition base3 = chest.addOrReplaceChild("base3", CubeListBuilder.create().texOffs(100, 104).addBox(-16.0F, -121.0F, -4.0F, 32.0F, 20.0F, 20.0F, new CubeDeformation(0.0F))
		.texOffs(188, 0).addBox(-16.0F, -117.0F, -8.0F, 32.0F, 16.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 93.0F, -4.0F));

		PartDefinition jacket = chest.addOrReplaceChild("jacket", CubeListBuilder.create().texOffs(0, 64).addBox(-20.0F, -101.0F, -8.0F, 40.0F, 8.0F, 28.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 93.0F, -4.0F));
		...
		PartDefinition ball = collar.addOrReplaceChild("ball", CubeListBuilder.create().texOffs(32, 154).addBox(-4.0F, 0.0F, -5.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 15.0F, -7.0F));
		...
		.texOffs(80, 144).addBox(-16.0F, -103.0F, 0.0F, 32.0F, 20.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 83.0F, -4.0F));
		...
		PartDefinition dress = hip.addOrReplaceChild("dress", CubeListBuilder.create().texOffs(128, 48).addBox(-24.0F, -72.0F, 16.0F, 48.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(128, 32).addBox(-24.0F, -72.0F, -12.0F, 48.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(236, 0).addBox(24.0F, -72.0F, -8.0F, 4.0F, 12.0F, 24.0F, new CubeDeformation(0.0F))
		.texOffs(256, 20).addBox(20.0F, -72.0F, -8.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(256, 20).addBox(-24.0F, -72.0F, -8.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(256, 20).addBox(-24.0F, -72.0F, 12.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(256, 20).addBox(20.0F, -72.0F, 12.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(104, 220).addBox(-28.0F, -72.0F, -8.0F, 4.0F, 12.0F, 24.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 68.0F, -4.0F));

		PartDefinition leftleg = Friend.addOrReplaceChild("leftleg", CubeListBuilder.create().texOffs(0, 154).addBox(-4.0F, 0.0F, -8.0F, 8.0F, 44.0F, 16.0F, new CubeDeformation(0.0F))
		.texOffs(0, 214).addBox(-8.0F, 0.0F, -4.0F, 16.0F, 44.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(204, 104).addBox(-8.0F, 40.0F, -8.0F, 16.0F, 20.0F, 16.0F, new CubeDeformation(0.0F))
		.texOffs(232, 36).addBox(-12.0F, 48.0F, 0.0F, 24.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(12.0F, -60.0F, 4.0F));

		PartDefinition shoecuff2 = leftleg.addOrReplaceChild("shoecuff2", CubeListBuilder.create().texOffs(268, 100).addBox(-7.0F, -20.0F, -4.0F, 4.0F, 8.0F, 16.0F, new CubeDeformation(0.0F))
		...
		.texOffs(292, 160).addBox(-3.0F, -20.0F, 12.0F, 16.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 60.0F, -4.0F));

		PartDefinition bone2 = leftleg.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(284, 60).addBox(-7.0F, -4.0F, -4.0F, 4.0F, 4.0F, 16.0F, new CubeDeformation(0.0F))
		...
		.texOffs(188, 20).addBox(-3.0F, -4.0F, 12.0F, 16.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 60.0F, -4.0F));
