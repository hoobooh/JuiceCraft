...
public class SoraEntityModel extends FriendEntityModel<Sora> {
	...
	public void defineAnimations(){
		this.animations=new Animations(IDLEGROUNDED,IDLEGROUNDED,IDLEGROUNDED,IDLEGROUNDED,IDLEGROUNDED,IDLEGROUNDED,IDLETRANSITION,PATGROUNDED,SIT,SITIMPATIENT,SITPAT,SLEEPINGPOSE,DEATHANIM,DEATHANIMSTART,ATTACKONE,ATTACKTWO,ATTACKTHREE,COUNTERANIM, BOWDRAW, ATTACKONE, ATTACKONE, ATTACKONE, ATTACKONE, ATTACKONE);
	}
