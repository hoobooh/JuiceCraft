...
public class AlteEntityRenderer extends FriendRenderer<Alte, AlteEntityModel> {
    private static final ResourceLocation ALTE_NEUTRAL = new ResourceLocation(MODID, "textures/entities/sora/neutral.png");
    private static final ResourceLocation ALTE_NARROW = new ResourceLocation(MODID, "textures/entities/sora/half.png");
    private static final ResourceLocation ALTE_CLOSED = new ResourceLocation(MODID, "textures/entities/sora/closed.png");
    private static final ResourceLocation ALTE_WINK = new ResourceLocation(MODID, "textures/entities/sora/wink.png");
    private static final ResourceLocation GLOW_OPEN = new ResourceLocation(MODID, "textures/entities/sora/glowopen.png");
    private static final ResourceLocation GLOW_NARROW = new ResourceLocation(MODID, "textures/entities/sora/glownarrow.png");
    private static final ResourceLocation GLOW_WINK = new ResourceLocation(MODID, "textures/entities/sora/glowwink.png");
    private static final ResourceLocation ALTE_ENERGYLAYER = new ResourceLocation(MODID, "textures/entities/sora/lightlayerfinal.png");
    private static final ResourceLocation SPARK_BASE = new ResourceLocation(MODID, "textures/entities/sora/spark_0.png");
    private static final ResourceLocation SPARK_BG0 = new ResourceLocation(MODID, "textures/entities/sora/spark_1.png");
    private static final ResourceLocation SPARK_BG1 = new ResourceLocation(MODID, "textures/entities/sora/spark_2.png");
    private static final ResourceLocation SPARK_BG2 = new ResourceLocation(MODID, "textures/entities/sora/spark_3.png");
    private static final ResourceLocation SPARK_BG3 = new ResourceLocation(MODID, "textures/entities/sora/spark_4.png");
