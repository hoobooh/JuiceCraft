...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<Seagull>> SEAGULL = ENTITIES.register("harbinger", () -> EntityType.Builder.of(Seagull::new, MobCategory.MONSTER).sized(0.5F, 0.9F).build("seagull"));
