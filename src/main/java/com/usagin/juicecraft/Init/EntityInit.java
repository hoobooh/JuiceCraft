...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<Harbinger>> HARBINGER = ENTITIES.register("harbinger", () -> EntityType.Builder.of(Harbinger::new, MobCategory.MONSTER).sized(1.5F, 3F).build("harbinger"));
}
