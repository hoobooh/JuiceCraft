...
public class BlockEntityInit {
    ...
    public static final RegistryObject<BlockEntityType<PlushieBlockEntity>> PLUSHIE = BLOCK_ENTITIES.register("plushie", () -> BlockEntityType.Builder.of(PlushieBlockEntity::new, ALTE_PLUSHIE.get()).build(null));
