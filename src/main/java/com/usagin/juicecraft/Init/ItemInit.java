...
public class ItemInit {
    ...
    public static final RegistryObject<Item> ACTIVATOR = ITEMS.register("activator", () -> new Item(new Item.Properties().stacksTo(1).durability(24000).defaultDurability(24000)));
